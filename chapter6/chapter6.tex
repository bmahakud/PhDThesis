...
We present a general search for gluino pair production leading to final states with large missing transverse energy ($\rm p_{T}^{miss}$), large scalar sum of transverse energy ($\rm H_{T}$), large number of jets ($\rm N_{jet}$) and large number of b-tagged jets ($\rm N_{b\texttt{-}jet}$). The event diagrams of gluino pair production that we considered in our analysis are shown below. We shall focus more on the $Z\rightarrow \nu \bar{\nu} $ invisible background estimation as this is the part of the analysis where we have contributed to the most. 
...
We categorize photons in the simulation as 
\begin{itemize}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.45\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/ith-Bin-EB__Data_MC_EB.pdf} % ADDNEWPLOT 
\includegraphics[width=0.45\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/ith-Bin-EE__Data_MC_EE.pdf} % ADDNEWPLOT 
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.45\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/HT__Data_MC_.pdf} % ADDNEWPLOT 
\includegraphics[width=0.45\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/MHT__Data_MC_.pdf} % ADDNEWPLOT 
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.45\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/NJets__Data_MC_.pdf} % ADDNEWPLOT 
\includegraphics[width=0.45\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/BJets__Data_MC_.pdf} % ADDNEWPLOT 
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.44\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/GJets-Prompt_Prompt_Ich-SR_lowHT_highHT__Baseline.png} 
\includegraphics[width=0.44\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/GJets-Prompt_Prompt_Ich-SR_lowNJet_highNJet__Baseline.png} 
%\includegraphics[width=0.32\textwidth]{/home/bibhu/Desktop/PhDThesis/PhDThesis/chapter6/SigmaIetaInMHTBins.png} 
...
\end{figure}
 ...
 The PDF for the prompt component is fit directly in data
...
%For the alternative prompt PDF, we parameterize the shape with a Gaussian distribution and allow the width to vary in the fit.
