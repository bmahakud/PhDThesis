...
%\textsc{\LARGE }\\[1.0cm] % Name of your university/college
...
yields in the 18 bins corresponding to \nbjets=0.  These are
...
\begin{figure}
\begin{center}
\includegraphics[width=0.35\textwidth]{ZGammaRatioWSF.pdf} % ADDNEWPLOT 
\includegraphics[width=0.30\textwidth]{ith-Bin-EB__Data_MC_EB.pdf} % ADDNEWPLOT 
\includegraphics[width=0.30\textwidth]{ith-Bin-EE__Data_MC_EE.pdf} % ADDNEWPLOT 
...
\begin{figure}
\centering
\includegraphics[width=10cm,height=5cm]{results-plot-prefit-12_9-log.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.32\textwidth]{Mee_PAS_eejj.pdf}
\includegraphics[width=0.32\textwidth]{sT_PAS_eejj.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.32\textwidth]{LQLimitPlot.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=15cm,height=5cm]{1DPFCHS_QCD.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{AvJetmass_Vs_nPV_PF_trim.pdf}
\includegraphics[width=0.3\textwidth]{AvJetmassSafe_PFCHS_prun.pdf}
\includegraphics[width=0.3\textwidth]{SummaryPFCHSallNPV.pdf}
