...
\hline
\end{tabular}
\footnotetext{In some parts of the thesis units of $\rm p_T$ and mass are GeV/c and $\rm GeV/c^2$ respectively while in some other parts we used natural units by taking $\hslash$ = c = 1.}
%%%%%%%%%\end{center}
